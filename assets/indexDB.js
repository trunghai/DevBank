...
var jsonData = {
  ...
  "arguments": [
    ...
    null,
    "MENU",
    "MENU_HOME_PAGE#ID30##lnr-home##updateAccountListInfo(); gotoHomePage();##Y",
    ...
    "MENU_PAY_INTERNATIONAL#ID34##lnr-earth##applyScrollForMe(this.parentNode);##Y",
    "MENU_SETUP#ID5##lnr-cog##applyScrollForMe(this.parentNode);##Y",
    ...
    "MENU_PAY_BILL#ID33#ID3#lnr-chevron-right##navController.initWithRootView('corp/payment_service/bill/pay_bill_create', true, 'html');##Y",
    ...
    "MENU_SETUP_SYSTEM#ID18#ID5#lnr-chevron-right##navController.initWithRootView('corp/setup/system/set_system', true, 'xsl');##Y",
    // "MENU_SETUP_TRANFER#ID19#ID5#icon-arrowright##navController.initWithRootView('corp/setup/tranfer/set_tranfer', true, 'xsl');##Y",
    "MENU_FOREGIN_CURRENCY_CONVERT#ID35#ID34#lnr-chevron-right##navController.initWithRootView('corp/international_payments/foreign_exchange/foreign_exchange', true, 'xsl');##Y",
