        ...
        <div id="mainViewContent" class="main-layout-subview">
          <div class="panelContent">
            <table width="100%">
              <tr>
                <td>
                  <h5 class="screen-title"><span style="white-space:pre-wrap;">MENU_TRANS_PERIODIC</span></h5>
            ...
            <table width="100%" align="center">
              ...
              <tr>
                <td>
                  <input type="button" onclick="searchPeriodicTrans()" class="btnshadow btn-second" value="TRANS_PERIODIC_BTN_SRCH" />
                </td>
              </tr>
            </table>
            <br />
