...
function loadInitData() {
	...
	angular.module("EbankApp").controller('transfer-internals',  function ($scope, requestMBServiceCorp) {
		// initData();
		function initData() {
			if (!gTrans.isBack){
				...
				requestMBServiceCorp.post(data, onSuccessInitData, onFailInitData);
			}
		}
