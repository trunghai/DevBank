                ...
                <tr>
                  <td colspan="2" align="center" valign="middle" class="td-text">
                    <div class="input-group" onClick="showTransTypeSelection()">
                      ...
                      <input id="id-trans-local" type="button" class="form-control form-control-righttext" style="white-space: pre-wrap;" align="left" value="TRANS_ACC_TRANSTYPE" />
				 ...
				 <tr>
                  <td colspan="2" align="center" valign="middle" class="td-text">
                    <div class="input-group">
                      <span class="input-group-addon" style="white-space:pre-wrap; width:40%">TRANS_ACC_DESTACC</span>
                      <input id="trans.targetaccount" type="text" placeholder="COM_TXT_INPUT_PLACEHOLDER" value="" class="form-control form-control-righttext-datepicker" onkeyup="controlInputText(this,33)" />
                  ...
                  <td colspan="2" align="center" valign="middle" class="td-text">
                    <div class="input-group" onClick="showBankSelection()">
                      <span class="input-group-addon" style="white-space:pre-wrap; width:40%">TRANS_BANK_TITLE_APPLY</span>
