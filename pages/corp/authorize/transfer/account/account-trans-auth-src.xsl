<?xml version="1.0" encoding="UTF-8"?>
  <xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
      ...
      <body>
        <div id="mainViewContent" class="main-layout-subview" ng-controller="account-trans-auth-src">
          <div class="panelContent">
            <table width="100%">
              <tr>
                <td>
                  <h5 class="screen-title"><span style="white-space:pre-wrap;">AUTHORIZE_TRANS_ACCOUNT</span></h5>
            ...
            <table width="100%" align="center">
              ...
              <tr>
                <td align="center" valign="middle" class="td-text">
                  <div class="input-group" onclick="showTransTypeSelection()">
                    ...
                    <input style="white-space:pre-wrap" id="id.trans-type" type="button" class="form-control form-control-righttext" value="AUTHORIZE_TRANS_TIT_T21" />
              ...
              <tr>
                <td>
                  <input id="btn_search" type="button" ng-click="sendJSONRequest()" class="btnshadow btn-second" value="TRANS_PERIODIC_BTN_SRCH" />
                </td>
              </tr>
            </table>
            <br />
