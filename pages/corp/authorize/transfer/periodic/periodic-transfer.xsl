<?xml version="1.0" encoding="UTF-8"?>
  <xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
      ...
      <body>
        <div id="mainViewContent" class="main-layout-subview" ng-controller="periodic-transfer">
          <div class="panelContent">
            <table width="100%">
                ...
                <td colspan="2">
                  <div>
                    <h5 class="screen-title">
                        <span>AUTHORIZE_TRANS_PERIODIC</span>
                      </h5>
                  </div>
              ...
              <tr>
                <td colspan="2" align="center" valign="middle" class="td-text">
                  <div class="input-group" onclick="showSearchInput(1)">
                    ...
                    <input style="white-space:pre-wrap" id="trans.type" type="button" class="form-control form-control-righttext" placeholder="PERIODIC_TRANSFER_TYPE_DEFAULT" value="PERIODIC_TRANSFER_TYPE_DEFAULT" />
                    <span class="icon-movenext input-group-addon input-group-symbol"></span>
                    <input type="hidden" id='id.value.trans.type' value="T15" />
                  </div>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>
                  <input id="btn_search" type="button" class="btnshadow btn-second" ng-click="searchListTransfer()" value="COM_BNTN_SEARCH" />
                </td>
              </tr>
            </table>
            <br/>
