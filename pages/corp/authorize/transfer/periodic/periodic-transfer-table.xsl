    ...
    <xsl:template match="/">
      <table width='98%' align='center' class='table-account  table-checkbox'>
        <tr class="trow-title" onClick="selectRow(event, this, true);">
          ...
          <th><span>COM_ACCOUNT_DEST</span></th>
        ...
        <xsl:for-each select="resptable/tabletdetail">
          <tr onClick="selectRow(event, this, false);">
            <td class="tdselct td-head-color">
              ...
              <div class="content-detail"><span style="word-break: break-all;"><xsl:value-of select="stt" /></span></div>
            </td>
            <td>
              <div class="mobile-mode"><span>COM_CREATED_DATE</span></div>
              <div class="content-detail"><span style="word-break: break-all;"><xsl:value-of select="datemake" /></span></div>
            </td>
            <td>
              <div class="mobile-mode"><span>COM_ACCOUNT_DEST</span></div>
              <div class="content-detail"><span style="word-break: break-all;"><xsl:value-of select="destAccount" /></span></div>
            </td>
            <td>
              <div class="mobile-mode"><span>COM_AMOUNT</span></div>
              <div class="content-detail"><span style="word-break: break-all;"><xsl:value-of select="amount" /></span></div>
            </td>
            <td>
              <div class="mobile-mode"><span>COM_RECEIVER</span></div>
              <div class="content-detail"><span style="word-break: break-all;"><xsl:value-of select="beneName" /></span></div>
            </td>
            <td>
              <div class="mobile-mode"><span>COM_CHEKER</span></div>
              <div class="content-detail"><span style="word-break: break-all;"><xsl:value-of select="approver" /></span></div>
            </td>
            <td>
      ...
      <table width="100%">
        ...
        <tr>
          <td colspan="2" align="center" valign="middle" class="td-text">
            <div class="input-group">
              <input id="trans.approve.reason" class="form-control" placeholder="AUTHORIZE_TXT_REASON" value="" maxlength="250" />
            </div>
          </td>
        </tr>
        ...
        <tr>
          <td>
            <input type="button" style="margin: 0;float: left;" class="btnshadow btn-primary" onclick="approveTransaction(false)" value="COM_REJ" />
          </td>
          <td>
