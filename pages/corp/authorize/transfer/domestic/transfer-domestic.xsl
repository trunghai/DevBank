<?xml version="1.0" encoding="UTF-8"?>
  <xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
      ...
      <body>
        <div id="mainViewContent" class="main-layout-subview" ng-controller="transfer-domestic">
                ...
                <td colspan="2">
                  <div>
                    <h5 class="screen-title">
                        <span>AUTHORIZE_TRANS_DOMESTIC</span>
                      </h5>
                  </div>
              ...
              <tr>
                <td colspan="2" align="center" valign="middle" class="td-text">
                  <div class="input-group" onclick="showSearchInput(1)">
                    ...
                    <input id="trans.type" type="button" class="form-control form-control-righttext" placeholder="TRANS_BATCH_TYPE_OTHER" value="TRANS_BATCH_TYPE_OTHER" />
                    <span class="icon-movenext input-group-addon input-group-symbol"></span>
                    <input type="hidden" id='id.value.trans.type' value="T13" />
                  </div>
                </td>
              </tr>
              <tr>
