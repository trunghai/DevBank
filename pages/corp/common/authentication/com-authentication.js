...
function requestMBServiceSuccess() {
    ...
    if(gTrans.idtxn == 'T11' || gTrans.idtxn == 'T12'){
        ...
        response = {"responseType":"1","respCode":"0","respContent":"Giao dịch thành công. Cảm ơn Quý khách đã giao dịch với eBank!","respRaw":"","arguments":[],"respJson":"","respJsonObj":{"transId":"1708910000031202","type":"1","time":"30/03/2017 10:19:13"}};
    }
